...
class UncompressedComponents {
    ...
    UncompressedComponents(UncompressedComponents const&); // not implemented
    UncompressedComponents& operator=(UncompressedComponents const&); // not implemented
	...
	public:
	    ...
	    friend bool decode_jpeg(std::vector<std::pair<uint32_t, uint32_t>> const& huff_byte_offsets,
