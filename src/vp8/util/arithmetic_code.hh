	...
	public:
		...
		class encoder {
			...
			public:
				...
				std::size_t get_bytes_emitted() const { return bytes_emitted; }
				...
				std::size_t put(int symbol, std::function<FixedPoint(FixedPoint)> probability_of_1) {
					...
					if (range < min_range) {
						...
						std::size_t emitted_before = get_bytes_emitted();
...
make_decoder(InputContainer const& container) {
